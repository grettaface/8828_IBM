...
(function(doc, win) {
  ...
  var donutty = (win.Donutty = function(el, options) {
    ...
    _this.options.min = isDefined(_this.options.min)
      ? float(_this.options.min)
      : 0;
    _this.options.max = isDefined(_this.options.max)
      ? float(_this.options.max)
      : 100;
    _this.options.value = isDefined(_this.options.value)
      ? float(_this.options.value)
      : 50;
    _this.options.round = isDefined(_this.options.round)
      ? truth(_this.options.round)
      : true;
    _this.options.circle = isDefined(_this.options.circle)
      ? truth(_this.options.circle)
      : true;
    _this.options.padding = isDefined(_this.options.padding)
      ? float(_this.options.padding)
      : 4;
